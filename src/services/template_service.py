...
class TemplateService:
    ...
    async def render_template(
        ...
        try:
            rendered_subject = render_jinja_template(
                template_body=template.subject, context=context
            )
            rendered_body = render_jinja_template(
                template_body=template.body, context=context
            )
